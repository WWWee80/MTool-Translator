import urllib.request, json, re, urllib.parse, time

print('等待DNS生效...')
time.sleep(3)

# 测试谷歌代理自定义域名
print('=== 谷歌翻译代理(自定义域名)测试 ===')
try:
    url = 'https://google.wwwee80.dpdns.org/translate_a/single?client=gtx&sl=en&tl=zh-CN&dt=t&q=hello'
...
try:
    ...
    if ig_m and ap_m:
        ...
        url2 = f'https://bing.wwwee80.dpdns.org/ttranslatev3?isVertical=1&IG={ig}&IID={iid}&SFX=1'
